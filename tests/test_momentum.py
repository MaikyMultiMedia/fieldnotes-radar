...
from momentum import signal,paper_update,ts,cap_signal
...
class MomentumTests(unittest.TestCase):
    ...
    def test_cap_alert_threshold_and_pool_guards(self):
        ...
        self.assertIsNone(cap_signal(sample(0,3500,2),sample(11,10000,15)))
        self.assertIsNone(cap_signal(sample(0,100,2),sample(5,300,2)))
        self.assertIsNone(cap_signal(sample(0,3500,2),sample(61,10000,15)))

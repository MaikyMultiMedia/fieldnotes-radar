...
- Independently verify token controls and owner-level concentration beyond the new GoPlus reports. Actual size-specific exit quotes remain additional work.
